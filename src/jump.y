...
#jumping variables
jump_state = "on ground"  # Possible states: "on ground", "jumping up", "coming down"
downward_threshold = 0.1  # threshold for starting a jump
upward_threshold = 0.1  # threshold for ending a jump
